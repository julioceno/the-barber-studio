    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      ...
      >
          <div className="mx-1 sm:mx-10 mt-5 sm:mt-10 mb-16">
              <h5 className="font-extrabold text-1xl xs:text-2xl md:text-3xl " >ESCOLHA A UNIDADE DESEJADA</h5>
              <p className="text-gray-700">Nós seguimos um padrão único de qualidade e excelência em nossos serviços. Independentemente da unidade que escolher, você terá o mesmo resultado. {/* TODO: ajustar */}</p>
